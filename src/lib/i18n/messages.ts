...
export const messages = {
	ko: {
		...
		'result.consistency.title': '🎲 취향 일관성',
		'result.consistency.perfect': '완벽하게 일관된 취향! 모순 0개 🎯',
		'result.consistency.summary': '일관성 {score}점 — 모순 {n}개 발견',
		'result.consistency.cycle': '가위바위보: {a} ＞ {b} ＞ {c} ＞ {a}',
		'result.share': '🔗 결과 링크 복사',
		'result.shareCopied': '✓ 링크 복사됨!',
		'result.playThis': '나도 해보기',
		'shared.badge': '공유된 결과',
		'shared.notFound': '이 링크의 주제를 찾을 수 없어요. 만든 사람의 기기에서만 볼 수 있는 주제일 수 있어요.',
		'shared.invalid': '링크가 올바르지 않거나 주제가 바뀌었어요.',
	...
	en: {
		...
		'result.consistency.title': '🎲 Taste consistency',
		'result.consistency.perfect': 'Perfectly consistent taste! 0 contradictions 🎯',
		'result.consistency.summary': '{score}% consistent — {n} contradictions found',
		'result.consistency.cycle': 'Rock-paper-scissors: {a} ＞ {b} ＞ {c} ＞ {a}',
		'result.share': '🔗 Copy result link',
		'result.shareCopied': '✓ Link copied!',
		'result.playThis': 'Play this yourself',
		'shared.badge': 'Shared result',
		'shared.notFound': "Couldn't find this topic. It may only exist on the creator's device.",
		'shared.invalid': 'The link is invalid or the topic has changed.',
	...
	zh: {
		...
		'result.consistency.title': '🎲 口味一致性',
		'result.consistency.perfect': '口味完全一致！0 处矛盾 🎯',
		'result.consistency.summary': '一致性 {score}分 — 发现 {n} 处矛盾',
		'result.consistency.cycle': '循环偏好：{a} ＞ {b} ＞ {c} ＞ {a}',
		'result.share': '🔗 复制结果链接',
		'result.shareCopied': '✓ 链接已复制！',
		'result.playThis': '我也来玩',
		'shared.badge': '分享的结果',
		'shared.notFound': '找不到这个主题，它可能只存在于创建者的设备上。',
		'shared.invalid': '链接无效或主题已更改。',
