	...
	},
	{
		...
		a: {
			...
			penalties: pens([
				'방귀를 수시로 소리 내며 뀌어도',
				'트림할 때 냄새까지 얼굴에 뿜어도',
				'양말을 사흘씩 신고 아무 데나 벗어놔도',
				'코를 판 그 손으로 리모컨을 만져도',
				'화장실 문 열고 볼일 보며 말 걸어도',
				'발가락 때를 소파에서 파며 티비 봐도',
				'씻자고 하면 "귀찮아" 하고 그냥 자도',
				'내 칫솔로 아무렇지 않게 양치해도',
				'평생 안 씻어도 본인은 늘 태평해도'
			])
		...
		b: {
			...
			penalties: pens([
				'집에 오면 무조건 30분 샤워부터 시켜도',
				'소파에 앉기 전 물티슈로 다 닦게 해도',
				'외출복으로 침대에 앉으면 잔소리 폭발해도',
				'손 씻는 걸 하루 스무 번씩 검사해도',
				'내 물건이 1cm만 어긋나도 참견해도',
				'친구가 다녀가면 온 집을 소독해도',
				'신발을 현관에서 알코올로 닦게 해도',
				'재채기 한 번에 온 방을 청소하게 해도',
				'평생 함께 청소만 하다 하루가 다 가도'
			])
		}
	},
	{
