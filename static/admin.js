...
// ─── 상태 ───
const state = { user: null, checking: true, tab: 'candidates', candidates: [], notmemes: [], memes: [], members: [], submissions: [], editing: null, eraSummary: null, eraByAge: [], eraItems: [] };
...
const MEME_COLS = 'id,name,keywords,description,tags,category,status,source,photo_url,video_url,media';
